...
start_index = 196 # 0부터 시작하므로 실제로는 10번째 항목
end_index = 320  # 실제로는 20번째 항목
    ...
    if start_index <= index <= end_index:
        ...
        if school_type == "고등학교":
            ...
            if first_file_path != None:
                ...
                output_file_path = f'C:/Users/POWER/Desktop/project_peanutbutterlee/데이터/{year}년도_{sem}학기_all_school_data_4.json'
