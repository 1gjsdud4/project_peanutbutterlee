...
def merge_teachers_and_subjects(teachers_data, subjects_data):
    ...
    for subject_info in subjects_data:
        ...
        if school_name in teachers_data:
            ...
            merged_school_data = {
                "ATPT_OFCDC_SC_CODE": subject_info["ATPT_OFCDC_SC_CODE"],
                "ATPT_OFCDC_SC_NM": subject_info["ATPT_OFCDC_SC_NM"],
                "SD_SCHUL_CODE": subject_info["SD_SCHUL_CODE"],
                "SCHUL_NM": subject_info["SCHUL_NM"],
                "SEM": subject_info["SEM"],
                "AY": subject_info["AY"],
                "Latitude": subject_info["Latitude"],
                "Longitude": subject_info["Longitude"],
                "고등학교구분명": subject_info["고등학교구분명"],
                "all_SUBJECT": subject_info["all_SUBJECT"],
